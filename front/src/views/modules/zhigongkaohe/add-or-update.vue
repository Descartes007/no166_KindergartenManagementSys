  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考核成绩" prop="kaohechengji">
          <el-input v-model="ruleForm.kaohechengji" 
              placeholder="考核成绩" clearable  :readonly="ro.kaohechengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考核成绩" prop="kaohechengji">
              <el-input v-model="ruleForm.kaohechengji" 
                placeholder="考核成绩" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否通过" prop="shifoutongguo">
          <el-select v-model="ruleForm.shifoutongguo" placeholder="请选择是否通过">
            <el-option
                v-for="(item,index) in shifoutongguoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否通过" prop="shifoutongguo">
	      <el-input v-model="ruleForm.shifoutongguo"
                placeholder="是否通过" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kaohechengji = true;
            continue;
	            	            ...
	            	            if(o=='shifoutongguo'){
            this.ruleForm.shifoutongguo = obj[o];
	    this.ro.shifoutongguo = true;
            continue;
          }
	            	            if(o=='kaoheriqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.shifoutongguoOptions = "是,否".split(',')
                                              },
                                                                // 多级联动参数
                                                                                  info(id) {
      this.$http({
        url: `zhigongkaohe/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhigongkaohe/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhigongkaoheCrossAddOrUpdateFlag = false;
                  this.parent.search();
