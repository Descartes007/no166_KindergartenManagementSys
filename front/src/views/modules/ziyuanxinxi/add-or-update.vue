          ...
          <el-form-item class="input" v-if="ruleForm.dengjiriqi" label="登记日期" prop="dengjiriqi">
              <el-input v-model="ruleForm.dengjiriqi" 
                placeholder="登记日期" readonly></el-input>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资源详情" prop="ziyuanxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ziyuanxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ziyuanxiangqing" label="资源详情" prop="ziyuanxiangqing">
                    <span v-html="ruleForm.ziyuanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dengjiriqi = true;
            continue;
	            	            ...
	            	            if(o=='ziyuanxiangqing'){
            this.ruleForm.ziyuanxiangqing = obj[o];
	    this.ro.ziyuanxiangqing = true;
            continue;
          }
	                    }
                                                                                                              }
	...
	this.ruleForm.ziyuanxiangqing = this.ruleForm.ziyuanxiangqing.replace(reg,'../../../springboot4023t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
