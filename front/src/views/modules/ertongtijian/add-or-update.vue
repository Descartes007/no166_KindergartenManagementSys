    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="家长姓名" prop="jiazhangxingming">
              <el-input v-model="ruleForm.jiazhangxingming" 
                placeholder="家长姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="幼儿姓名" prop="youerxingming">
          <el-input v-model="ruleForm.youerxingming" 
              placeholder="幼儿姓名" clearable  :readonly="ro.youerxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="幼儿姓名" prop="youerxingming">
              <el-input v-model="ruleForm.youerxingming" 
                placeholder="幼儿姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="身高" prop="shengao">
              <el-input v-model="ruleForm.shengao" 
                placeholder="身高" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="血型" prop="xuexing">
        ...
        <el-form-item class="select" v-if="type!='info'"  label="健康状况" prop="jiankangzhuangkuang">
          <el-select v-model="ruleForm.jiankangzhuangkuang" placeholder="请选择健康状况">
            <el-option
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="成长轨迹" prop="chengzhangguiji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="成长轨迹"
                  v-model="ruleForm.chengzhangguiji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chengzhangguiji" label="成长轨迹" prop="chengzhangguiji">
                    <span>{{ruleForm.chengzhangguiji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiazhangxingming = true;
            continue;
	            	            ...
	            	            if(o=='youerxingming'){
            this.ruleForm.youerxingming = obj[o];
	    this.ro.youerxingming = true;
            continue;
          }
	            	            if(o=='tizhong'){
	    ...
	    this.ro.jiankangzhuangkuang = true;
            continue;
	            	            ...
	            	            if(o=='chengzhangguiji'){
            this.ruleForm.chengzhangguiji = obj[o];
	    this.ro.chengzhangguiji = true;
            continue;
          }
	            	            if(o=='pingjia'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.xuexingOptions = "AB,A,B,O".split(',')
                                        this.jiankangzhuangkuangOptions = "健康,不健康".split(',')
                                                                                                                      },
                    // 下二随
    yonghumingChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
                ...
                this.ruleForm.jiazhangxingming = data.data.jiazhangxingming
                                                ...
                                                if(data.data.youerxingming){
                this.ruleForm.youerxingming = data.data.youerxingming
              }
                                                                                                                                                                                                                                    } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ertongtijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ertongtijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
