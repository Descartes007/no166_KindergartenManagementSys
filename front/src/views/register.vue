  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">幼儿园管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="家长姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jiazhangxingming" autocomplete="off" placeholder="家长姓名" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">幼儿姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.youerxingming" class="input" type="text" placeholder="幼儿姓名">
			   </div>
			 </div> -->
			<el-form-item label="幼儿姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youerxingming" autocomplete="off" placeholder="幼儿姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='yonghu'" class="input-group">
