          ...
          <el-form-item class="input" label="年龄" prop="nianling">
              <el-input v-model="ruleForm.nianling" 
                placeholder="年龄" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="班级名称" prop="banjimingcheng">
          <el-select v-model="ruleForm.banjimingcheng" placeholder="请选择班级名称">
            <el-option
                v-for="(item,index) in banjimingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                this.banjimingchengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `youerxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youerxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
