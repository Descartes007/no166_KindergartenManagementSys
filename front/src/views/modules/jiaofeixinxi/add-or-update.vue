  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="缴费时间" prop="jiaofeishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaofeishijian" label="缴费时间" prop="jiaofeishijian">
              <el-input v-model="ruleForm.jiaofeishijian" 
                placeholder="缴费时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="书本费" prop="shubenfei">
              <el-input v-model="ruleForm.shubenfei" 
                placeholder="书本费" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="伙食费" prop="huoshifei">
          <el-input v-model="ruleForm.huoshifei" 
              placeholder="伙食费" clearable  :readonly="ro.huoshifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="伙食费" prop="huoshifei">
              <el-input v-model="ruleForm.huoshifei" 
                placeholder="伙食费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学费" prop="jiaoxuefei">
          <el-input v-model="ruleForm.jiaoxuefei" 
              placeholder="教学费" clearable  :readonly="ro.jiaoxuefei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学费" prop="jiaoxuefei">
              <el-input v-model="ruleForm.jiaoxuefei" 
                placeholder="教学费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  huoshifei: [
                            { required: true, message: '伙食费不能为空', trigger: 'blur' },
                                                    { validator: validateNumber, trigger: 'blur' },
            	                                                              ],
                  jiaoxuefei: [
                            { required: true, message: '教学费不能为空', trigger: 'blur' },
                                                    { validator: validateNumber, trigger: 'blur' },
            	                                                              ],
                  zongfeiyong: [
                                                    { validator: validateNumber, trigger: 'blur' },
  ...
  computed: {
                                                                                                    zongfeiyong: {
                                                                                                                                                                                                                                                                                      get: function () {
        return 0+parseFloat(this.ruleForm.shubenfei==""?0:this.ruleForm.shubenfei)+parseFloat(this.ruleForm.huoshifei==""?0:this.ruleForm.huoshifei)+parseFloat(this.ruleForm.jiaoxuefei==""?0:this.ruleForm.jiaoxuefei) || 0
      }
    },
                                              },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shubenfei = true;
            continue;
	            	            ...
	            	            if(o=='huoshifei'){
            this.ruleForm.huoshifei = obj[o];
	    this.ro.huoshifei = true;
            continue;
          }
	            	            if(o=='jiaoxuefei'){
            this.ruleForm.jiaoxuefei = obj[o];
	    this.ro.jiaoxuefei = true;
            continue;
          }
	            	            if(o=='zongfeiyong'){
