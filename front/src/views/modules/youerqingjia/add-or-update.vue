          ...
          <el-form-item class="input" label="家长姓名" prop="jiazhangxingming">
              <el-input v-model="ruleForm.jiazhangxingming" 
                placeholder="家长姓名" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="请假内容" prop="qingjianeirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="请假内容"
                  v-model="ruleForm.qingjianeirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qingjianeirong" label="请假内容" prop="qingjianeirong">
                    <span>{{ruleForm.qingjianeirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qingjiatianshu = true;
            continue;
	            	            ...
	            	            if(o=='qingjianeirong'){
            this.ruleForm.qingjianeirong = obj[o];
	    this.ro.qingjianeirong = true;
            continue;
          }
	            	            if(o=='yonghuming'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `youerqingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youerqingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
