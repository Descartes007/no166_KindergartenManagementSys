<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会议名称" prop="huiyimingcheng">
          <el-input v-model="ruleForm.huiyimingcheng" 
              placeholder="会议名称" clearable  :readonly="ro.huiyimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会议名称" prop="huiyimingcheng">
              <el-input v-model="ruleForm.huiyimingcheng" 
                placeholder="会议名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="会议时间" prop="huiyishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huiyishijian" label="会议时间" prop="huiyishijian">
              <el-input v-model="ruleForm.huiyishijian" 
                placeholder="会议时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                <el-col :span="12">
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="会议内容" prop="huiyineirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="会议内容"
                  v-model="ruleForm.huiyineirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huiyineirong" label="会议内容" prop="huiyineirong">
                    <span>{{ruleForm.huiyineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="会议心得" prop="huiyixinde">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="会议心得"
                  v-model="ruleForm.huiyixinde" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huiyixinde" label="会议心得" prop="huiyixinde">
                    <span>{{ruleForm.huiyixinde}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huiyimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='huiyishijian'){
            this.ruleForm.huiyishijian = obj[o];
	    this.ro.huiyishijian = true;
            continue;
          }
	            	            if(o=='huiyineirong'){
            this.ruleForm.huiyineirong = obj[o];
	    this.ro.huiyineirong = true;
            continue;
          }
	            	            if(o=='huiyixinde'){
            this.ruleForm.huiyixinde = obj[o];
	    this.ro.huiyixinde = true;
            continue;
          }
	            	            if(o=='gonghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `huiyijilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyijiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
