          ...
          <el-form-item class="input" v-if="ruleForm.riqi" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
                placeholder="日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="时间" prop="shijian">
          <el-select v-model="ruleForm.shijian" placeholder="请选择时间">
            <el-option
                v-for="(item,index) in shijianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.shijian"
                placeholder="时间" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="菜品名单" prop="caipinmingdan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="菜品名单"
                  v-model="ruleForm.caipinmingdan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.caipinmingdan" label="菜品名单" prop="caipinmingdan">
                    <span>{{ruleForm.caipinmingdan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yingyangfenxi" label="营养分析" prop="yingyangfenxi">
                    <span>{{ruleForm.yingyangfenxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shijian = true;
            continue;
	            	            ...
	            	            if(o=='caipinmingdan'){
            this.ruleForm.caipinmingdan = obj[o];
	    this.ro.caipinmingdan = true;
            continue;
          }
	            	            if(o=='yingyangfenxi'){
